...
const Home = () => {
  return <>
    ...
    <h1 className="pl-52 text-white text-7xl font-noto-serif-jp font-bold p-6">INTRODUCTION</h1>
    ...
    <h1 className="pl-52 text-white text-7xl font-noto-serif-jp font-bold pt-16">CHARACTERS</h1>
    <p className="pl-52 text-3xl font-noto-serif-jp w-5/6 break-words text-white tracking-wide p-6">As the story progresses, the character page will be regularly updated with the latest information on each character. 
