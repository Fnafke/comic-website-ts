...
public class DbInitializer {
    ...
    public void init() {
        ...
        final var draftChapter2 = chapterRepository.save(new Chapter(2, "b5i5lOd", "Part 2: The World vs. Killer Queen",
        ...
        final var draftChapter19 = chapterRepository.save(new Chapter(19, "VtZ7cfU", "You sure can put up a fight!",
